...
class PaymentBloc extends Bloc<PaymentEvent, PaymentState> {
  ...
  Future<Map<String, dynamic>> _callPayEndpointMethodId({
    ...
    final url = Uri.parse(
        'https://us-central1-max-stripe-app.cloudfunctions.net/StripePayEndpointMethodId');
  ...
  Future<Map<String, dynamic>> _callPayEndpointIntentId({
    ...
    final url = Uri.parse(
        'https://us-central1-max-stripe-app.cloudfunctions.net/StripePayEndpointIntentId');
